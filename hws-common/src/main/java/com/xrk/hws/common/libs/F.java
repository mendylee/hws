...
public class F 
{
    ...
    public static class Promise<V> implements Future<V>, F.Action<V> 
    {
        ...
        public static <A, B, C, D, E> Promise<F.E5<A, B, C, D, E>> waitEither(final Promise<A> tA, final Promise<B> tB, final Promise<C> tC, 
        																	  final Promise<D> tD, final Promise<E> tE) 
        {
