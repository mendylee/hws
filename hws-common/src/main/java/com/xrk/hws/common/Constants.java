...
public final class Constants
{
    ...
    public static final String  DUBBO_PROPERTIES_KEY               = "hws.properties.file";

    public static final String  DEFAULT_DUBBO_PROPERTIES           = "hws.properties";
    ...
    public static final String  DEFAULT_DIRECTORY                  = "hws";

    public static final String  DEFAULT_LOADBALANCE                = "random";

    public static final String  DEFAULT_PROTOCOL                   = "hws";
    ...
    public static final String  DEFAULT_REMOTING_CODEC             = "hws";
    ...
    public static final String  DEFAULT_THREAD_NAME                = "Hws";
    ...
    public static final String  DEFAULT_REGISTRY                   = "hws";
    ...
    public static final String  DEFAULT_PROMPT                     = "hws>";
    ...
    public static final String  DUBBO_VERSION_KEY                  = "hws";
    ...
    @Deprecated
    public static final String  SHUTDOWN_WAIT_SECONDS_KEY          = "hws.service.shutdown.wait.seconds";

    public static final String  SHUTDOWN_WAIT_KEY                  = "hws.service.shutdown.wait";
    ...
    public static final String  STUB_EVENT_KEY                     = "hws.stub.event";

    public static final boolean DEFAULT_STUB_EVENT                 = false;

    public static final String  STUB_EVENT_METHODS_KEY             = "hws.stub.event.methods";
